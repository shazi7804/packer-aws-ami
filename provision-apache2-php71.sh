...
sudo DEBIAN_FRONTEND=noninteractive apt-get install apache2 libapache2-mod-fastcgi \
       php7.1-{cli,common,fpm,mysql,mongodb,mcrypt,gd,json,bcmath,mbstring,xml,xmlrpc,zip,soap,sqlite3,curl,opcache,readline}  -y
...
<IfModule mod_fastcgi.c>
  ...
  FastCgiExternalServer /usr/lib/cgi-bin/php7.fcgi -socket /var/run/php/php7.1-fpm.sock -pass-header Authorization -idle-timeout 360
...
EOF
sudo systemctl enable {apache2,php7.1-fpm}
